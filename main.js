             ...
             console.log(keyPressed);
              if(keyPressed == '68') { right();
                ...
                function up() {
                     ...
                     console.log("Cuando se presione la tecla W, x = " + rover_x + " | y = " +rover_y);
                      uploadBackground();
                       uploadrover();
                     }
                     }
                     ...
                     function down() {
                        ...
                        console.log("Cuando se presione la tecla S, x = " + rover_x + " | y = " +rover_y);
                         uploadBackground();
                          uploadrover();
                        }
                        }
                        ...
                        function left() {
                            ...
                            console.log("Cuando se presione la tecla A, x = " + rover_x + " | y = " +rover_y);
                             uploadBackground();
                              uploadrover();
                            }
                            }
                            ...
                            function right() {
                                ...
                                console.log("Cuando se presione la tecla D, x = " + rover_x + " | y = " +rover_y);
                                 uploadBackground();
                                  uploadrover();
                                }
                                }